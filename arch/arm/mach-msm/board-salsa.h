...
/* Keypad */
#define SALSA_GPIO_KEY_POWER		35
#define SALSA_GPIO_KEY_CAM_AUTOFCS	34
#define SALSA_GPIO_KEY_CAM_CAPTURE	38
#define SALSA_GPIO_KEY_VOLUME_DOWN	41
#define SALSA_GPIO_KEY_VOLUME_UP	42
